...
/**
 * 腾讯混元大模型Provider实现<br/>
 * API文档：<a href="https://cloud.tencent.com/document/product/1729/111007">...</a><br/>
 * <p>
 * API Key 管理页面<br/>
 * <a href="https://console.cloud.tencent.com/cam/capi">...</a>
 *
 * @author 百岁 (baisui@qlangtech.com)
 * @date 2026/8/30
 */
public class HunyuanLLMProvider extends LLMProvider {
    private static final Logger logger = LoggerFactory.getLogger(HunyuanLLMProvider.class);

    private static final String URL_PATH = "/v1/chat/completions";
    public static final String DEFAULT_MODEL = "hunyuan-standard";
    public static final String DEFAULT_BASE_URL = "https://api.hunyuan.cloud.tencent.com";
    ...
    public static final class DftDescriptor extends BasicParamsConfigDescriptor implements IEndTypeGetter {
        ...
        protected boolean verify(IControlMsgHandler msgHandler, Context context, PostFormVals postFormVals) {
            HunyuanLLMProvider provider = postFormVals.newInstance();
            try {
