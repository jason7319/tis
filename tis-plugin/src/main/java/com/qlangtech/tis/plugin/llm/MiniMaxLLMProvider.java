...
/**
 * MiniMax（稀宇科技）大模型Provider实现<br/>
 * 支持思考模式（thinking）等特殊功能<br/>
 * API文档：<a href="https://platform.minimax.io/docs/api-reference/text-chat">...</a><br/>
 * <p>
 * API Key 管理页面<br/>
 * <a href="https://platform.minimax.io/console/api-keys">...</a>
 *
 * @author 百岁 (baisui@qlangtech.com)
 * @date 2026/8/30
 */
public class MiniMaxLLMProvider extends LLMProvider {
    private static final Logger logger = LoggerFactory.getLogger(MiniMaxLLMProvider.class);

    private static final String URL_PATH = "/v1/chat/completions";
    public static final String DEFAULT_MODEL = "MiniMax-M3";
    public static final String DEFAULT_BASE_URL = "https://api.minimax.io";
    ...
    protected void addCustomizeParams(ITISJsonSchema jsonOutput, List<String> systemPrompt, LLMOptionParams params,
        ...
        // MiniMax 支持思考模式（adaptive/standard/none）
        if (this.enableThinking != null && this.enableThinking) {
    ...
    public static final class DftDescriptor extends BasicParamsConfigDescriptor implements IEndTypeGetter {
        ...
        protected boolean verify(IControlMsgHandler msgHandler, Context context, PostFormVals postFormVals) {
            MiniMaxLLMProvider provider = postFormVals.newInstance();
            try {
