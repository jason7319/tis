...
/**
 * OpenAI GPT 大模型Provider实现<br/>
 * API文档：<a href="https://platform.openai.com/docs/api-reference/chat/create">...</a><br/>
 * <p>
 * API Key 管理页面<br/>
 * <a href="https://platform.openai.com/api-keys">...</a>
 *
...
public class OpenAIProvider extends LLMProvider {
    ...
    public static final class DftDescriptor extends BasicParamsConfigDescriptor implements IEndTypeGetter {
        ...
        protected boolean verify(IControlMsgHandler msgHandler, Context context, PostFormVals postFormVals) {
            OpenAIProvider openAI = postFormVals.newInstance();
            try {
                LLMResponse chat = openAI.chat(IAgentContext.createNull(), new UserPrompt("test", "hello"), null);
                if (!chat.isSuccess()) {
