...
/**
 * 月之暗面 Kimi 大模型Provider实现<br/>
 * API文档：<a href="https://platform.moonshot.cn/docs/api/chat">...</a><br/>
 * <p>
 * API Key 管理页面<br/>
 * <a href="https://platform.moonshot.cn/console/api-keys">...</a>
 *
 * @author 百岁 (baisui@qlangtech.com)
 * @date 2026/8/30
 */
public class KimiLLMProvider extends LLMProvider {
    private static final Logger logger = LoggerFactory.getLogger(KimiLLMProvider.class);

    private static final String URL_PATH = "/v1/chat/completions";
    public static final String DEFAULT_MODEL = "moonshot-v1-auto";
    ...
    public static final class DftDescriptor extends BasicParamsConfigDescriptor implements IEndTypeGetter {
        ...
        protected boolean verify(IControlMsgHandler msgHandler, Context context, PostFormVals postFormVals) {
            KimiLLMProvider provider = postFormVals.newInstance();
            try {
