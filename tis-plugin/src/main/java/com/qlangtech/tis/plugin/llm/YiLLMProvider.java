...
/**
 * 零一万物 Yi 大模型Provider实现<br/>
 * API文档：<a href="https://platform.lingyiwanwu.com/docs">...</a><br/>
 * <p>
 * API Key 管理页面<br/>
 * <a href="https://platform.lingyiwanwu.com/api-keys">...</a>
 *
 * @author 百岁 (baisui@qlangtech.com)
 * @date 2026/8/30
 */
public class YiLLMProvider extends LLMProvider {
    private static final Logger logger = LoggerFactory.getLogger(YiLLMProvider.class);

    private static final String URL_PATH = "/v1/chat/completions";
    public static final String DEFAULT_MODEL = "yi-lightning";
    ...
    public static final class DftDescriptor extends BasicParamsConfigDescriptor implements IEndTypeGetter {
        ...
        protected boolean verify(IControlMsgHandler msgHandler, Context context, PostFormVals postFormVals) {
            YiLLMProvider provider = postFormVals.newInstance();
            try {
