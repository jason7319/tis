...
/**
 * Mistral AI 大模型Provider实现<br/>
 * API文档：<a href="https://docs.mistral.ai/api/">...</a><br/>
 * <p>
 * API Key 管理页面<br/>
 * <a href="https://console.mistral.ai/api-keys/">...</a>
 *
 * @author 百岁 (baisui@qlangtech.com)
 * @date 2026/8/30
 */
public class MistralLLMProvider extends LLMProvider {
    ...
    public static final class DftDescriptor extends BasicParamsConfigDescriptor implements IEndTypeGetter {
        ...
        protected boolean verify(IControlMsgHandler msgHandler, Context context, PostFormVals postFormVals) {
            MistralLLMProvider provider = postFormVals.newInstance();
            try {
