...
/**
 * xAI Grok 大模型Provider实现<br/>
 * API文档：<a href="https://docs.x.ai/api">...</a><br/>
 * <p>
 * API Key 管理页面<br/>
 * <a href="https://console.x.ai/">...</a>
 *
 * @author 百岁 (baisui@qlangtech.com)
 * @date 2026/8/30
 */
public class GrokLLMProvider extends LLMProvider {
    private static final Logger logger = LoggerFactory.getLogger(GrokLLMProvider.class);

    private static final String URL_PATH = "/v1/chat/completions";
    public static final String DEFAULT_MODEL = "grok-3";
    ...
    protected void addCustomizeParams(ITISJsonSchema jsonOutput, List<String> systemPrompt, LLMOptionParams params,
        ...
        // Grok 支持推理模式，可通过 reasoning_effort 参数控制推理强度
        // 可选值: "none", "low", "medium", "high"
        // postParams.add(new HttpUtils.PostParam("reasoning_effort", "medium"));
    ...
    public static final class DftDescriptor extends BasicParamsConfigDescriptor implements IEndTypeGetter {
        ...
        protected boolean verify(IControlMsgHandler msgHandler, Context context, PostFormVals postFormVals) {
            GrokLLMProvider provider = postFormVals.newInstance();
            try {
