...
/**
 * 百川智能 Baichuan 大模型Provider实现<br/>
 * API文档：<a href="https://platform.baichuan-ai.com/docs/api">...</a><br/>
 * <p>
 * API Key 管理页面<br/>
 * <a href="https://platform.baichuan-ai.com/console/api-keys">...</a>
 *
 * @author 百岁 (baisui@qlangtech.com)
 * @date 2026/8/30
 */
public class BaichuanLLMProvider extends LLMProvider {
    private static final Logger logger = LoggerFactory.getLogger(BaichuanLLMProvider.class);

    private static final String URL_PATH = "/v1/chat/completions";
    public static final String DEFAULT_MODEL = "Baichuan4-Turbo";
    ...
    public static final class DftDescriptor extends BasicParamsConfigDescriptor implements IEndTypeGetter {
        ...
        protected boolean verify(IControlMsgHandler msgHandler, Context context, PostFormVals postFormVals) {
            BaichuanLLMProvider provider = postFormVals.newInstance();
            try {
